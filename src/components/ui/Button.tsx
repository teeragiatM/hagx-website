...
const variantClasses: Record<ButtonVariant, string> = {
  primary:
    "bg-[#ff8a00] text-white border border-transparent hover:bg-[#e67a00] active:bg-[#cc6d00]",
  secondary:
    "border border-white/22 text-white/70 bg-transparent hover:border-white hover:bg-white hover:text-[#080808]",
  ghost:
    "border border-[#ff8a00] text-[#ff8a00] bg-transparent hover:bg-[#ff8a00] hover:text-white",
  outline:
...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const base = cn(
      "inline-flex items-center justify-center font-light uppercase transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ff8a00]/50 select-none",
