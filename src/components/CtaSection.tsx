...
export default function CtaSection({
  ...
  return (
    <section className={`relative overflow-hidden border-t border-white/[0.06] bg-[#080808] px-6 py-24 text-center sm:px-10 lg:py-32 ${className}`}>
      ...
      <div className="pointer-events-none absolute inset-x-0 bottom-0 h-px bg-gradient-to-r from-transparent via-[#ff8a00]/45 to-transparent" />

      <div className="relative mx-auto flex max-w-4xl flex-col items-center">
        {eyebrow && (
          <p className="mb-4 text-xs font-light uppercase tracking-[0.28em] text-[#ff8a00]">
            {eyebrow}
          </p>
        )}
        ...
        <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
          <Link
            ...
            className="inline-flex h-14 min-w-[220px] items-center justify-center bg-[#ff8a00] px-9 text-xs font-light uppercase tracking-[0.22em] text-white transition-colors hover:bg-[#e07a00]"
          >
            {primaryAction.label}
          </Link>
