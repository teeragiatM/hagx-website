...
const cols = [
  ...
  },
  {
    heading: "Services",
    links: [
      ["/services", "Curtain Wall System"],
      ["/services", "Glass Facade & Cladding"],
      ["/services", "Interior Partition"],
      ["/services", "Sliding & Folding Doors"],
  ...
  },
  {
    heading: "Contact",
    links: [
      ["mailto:hello@hagx.co", "hello@hagx.co"],
    ...
    <footer className="border-t border-white/[0.06] bg-[#080808]">
        ...
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-[1.6fr_1fr_1fr_1fr]">
          ...
          <div>
            ...
            <p className="mt-6 max-w-xs text-xs font-light leading-6 text-white/30">
              ...
              ออกแบบ ผลิต และติดตั้งด้วยมาตรฐานสถาปัตยกรรม — Bangkok, Thailand.
            </p>
          ...
          {cols.map((col) => (
            <div key={col.heading}>
              <p className="mb-5 text-[10px] font-light uppercase tracking-widest text-white/25">{col.heading}</p>
      ...
      <div className="mx-auto max-w-[1500px] px-8 py-6 sm:px-12 lg:px-16">
        <div className="flex flex-col justify-between gap-3 text-[10px] font-light text-white/20 sm:flex-row sm:items-center">
          <p>© 2026 HAGX Co., Ltd. All rights reserved.</p>
          <p>Architectural Precision · Bangkok, Thailand</p>
        </div>
      </div>
    </footer>
  );
