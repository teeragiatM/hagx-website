  ...
  return (
    <Bleed>
      ...
      >
        ...
        <div className="z-10 mx-auto  w-full max-w-(--homepage-max-width) py-[var(--header-height)] px-(--homepage-outer-padding)">
          <Animate
          ...
          >
            ...
            {subtitle && (
              <Animate.Item>
                ...
                >
                  <p className="leading-7 font-light whitespace-pre-line text-foreground-200">
                    {subtitle}
                  </p>
                </div>
              </Animate.Item>
