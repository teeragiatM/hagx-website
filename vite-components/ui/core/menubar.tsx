...
function MenubarCheckboxItem({
  ...
  return (
    <MenubarPrimitive.CheckboxItem
      ...
      {...props}
    >
      <span className="flex absolute left-1.5 items-center justify-center size-4 pointer-events-none [&_svg:not([class*='size-'])]:size-4">
